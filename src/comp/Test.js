...
class Test extends Component {
    ...
    componentDidMount(){
        this.socket = mySocket("https://lab06-socket.herokuapp.com/");
    ...
    render() {
        ...
        if(this.state.screen === 0){
            ...
            comp=(
                ...
                comp=(    
                    <div>
                        <input ref="q" type="test" placeholder="Ask a Question"/>
                        <input ref="o1" type="test" placeholder="Option 1"/>
                        <input ref="o2" type="test" placeholder="Option 2"/>
                        <select ref="a">
